  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-slate-900 text-white py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-2 w-fit hover:opacity-80 transition-opacity">
            ...
            <span className="text-2xl font-bold">tryst</span>
          </Link>
        </div>
      </header>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl font-bold text-slate-900 mb-8">Provider sign up</h1>

        {/* Info Banner */}
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-8">
          <p className="text-slate-700">
            Want to contact providers?{' '}
            <a href="/signup/client" className="text-blue-600 hover:underline font-semibold">
        ...
        <form onSubmit={handleSignup} className="space-y-8">
          {/* Working Name Field */}
          <div>
            <label htmlFor="workingName" className="block text-sm font-semibold text-slate-900 mb-2">
              Working name
            </label>
            <input
              id="workingName"
            ...
            <div className="flex gap-2 mt-2 text-sm text-slate-600">
              ...
              <span>Your working name, not your legal name. No locations, emojis, or symbols please.</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2 mt-2 text-sm text-slate-600">
              <AlertCircle className="w-4 h-4 flex-shrink-0 mt-0.5" />
              <span>This is how we will keep in touch with you. We recommend using a different address for your account and profile so you&apos;re always sure an email is really from us.</span>
            </div>
          </div>
