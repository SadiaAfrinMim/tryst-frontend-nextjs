...
const profiles: Profile[] = [
  {
    ...
    age: 24,
    image: 'https://images.unsplash.com/photo-1511338636513-b35a45b69713?w=400&h=500&fit=crop',
    rating: 4.8,
    verified: true,
  },
  {
  ...
  },
  {
    ...
    location: 'London, UK',
    age: 23,
    image: 'https://images.unsplash.com/photo-1534528741775-53a8c7b1e6d8?w=400&h=500&fit=crop',
    rating: 4.7,
    verified: true,
  },
  {
...
export function ProfileGridActive() {
  return (
          ...
          {profiles.map((profile) => (
            ...
            >
              ...
              <div className="relative h-[300px] md:h-[380px]">
                ...
                {/* Top Left Bookmark */}
                <div className="absolute top-2 left-2 bg-white/80 px-1 py-0.5 rounded text-xs z-10">
                  ★
                </div>

                {/* Top Right Tags */}
                <div className="absolute top-2 right-2 flex items-center gap-2 text-xs z-10">
              ...
              <div className="absolute bottom-0 left-0 w-full bg-white transition-transform duration-300 translate-y-full group-hover:translate-y-0 group-active:translate-y-0 z-10">
                <div className="p-3">
                  ...
                  <p className="text-black text-xs text-center mt-2 pt-2 border-t border-gray-200">
